...
build/vsetvl_sew8_lmul1.elf:     file format elf32-littleriscv
...
80000004:	100e0e13          	addi	t3,t3,256 # 8100 <_start-0x7fff7f00>
80000008:	00a00513          	li	a0,10
8000000c:	04000593          	li	a1,64
