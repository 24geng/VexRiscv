...
build/vsetvl_sew32_lmulf2.elf:     file format elf32-littleriscv
...
80000004:	10be0e13          	addi	t3,t3,267 # 810b <_start-0x7fff7ef5>
80000008:	00a00513          	li	a0,10
8000000c:	05700593          	li	a1,87
