...
build/vsetvl_sew64_lmulf2.elf:     file format elf32-littleriscv
...
80000004:	10fe0e13          	addi	t3,t3,271 # 810f <_start-0x7fff7ef1>
80000008:	00a00513          	li	a0,10
8000000c:	05f00593          	li	a1,95
