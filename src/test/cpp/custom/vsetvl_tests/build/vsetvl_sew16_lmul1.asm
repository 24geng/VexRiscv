...
build/vsetvl_sew16_lmul1.elf:     file format elf32-littleriscv
...
80000004:	104e0e13          	addi	t3,t3,260 # 8104 <_start-0x7fff7efc>
80000008:	00a00513          	li	a0,10
8000000c:	04800593          	li	a1,72
