...
build/vsetvli_avl_zero.elf:     file format elf32-littleriscv


Disassembly of section .text:

80000000 <_start>:
80000000:	00700e13          	li	t3,7
80000004:	00000513          	li	a0,0
80000008:	0d0572d7          	vsetvli	t0,a0,e32,m1,ta,ma,d1
