...
build/vsetvl_sew32_lmul2.elf:     file format elf32-littleriscv
...
80000004:	109e0e13          	addi	t3,t3,265 # 8109 <_start-0x7fff7ef7>
80000008:	00a00513          	li	a0,10
8000000c:	05100593          	li	a1,81
