...
build/vsetvl_sew8_lmul2.elf:     file format elf32-littleriscv
...
80000004:	101e0e13          	addi	t3,t3,257 # 8101 <_start-0x7fff7eff>
80000008:	00a00513          	li	a0,10
8000000c:	04100593          	li	a1,65
