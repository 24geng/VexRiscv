...
build/vsetvl_sew32_lmul1.elf:     file format elf32-littleriscv
...
80000004:	108e0e13          	addi	t3,t3,264 # 8108 <_start-0x7fff7ef8>
80000008:	00a00513          	li	a0,10
8000000c:	05000593          	li	a1,80
