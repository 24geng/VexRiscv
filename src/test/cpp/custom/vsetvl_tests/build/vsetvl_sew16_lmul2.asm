...
build/vsetvl_sew16_lmul2.elf:     file format elf32-littleriscv
...
80000004:	105e0e13          	addi	t3,t3,261 # 8105 <_start-0x7fff7efb>
80000008:	00a00513          	li	a0,10
8000000c:	04900593          	li	a1,73
