...
build/vsetvli_sew32_lmulf2.elf:     file format elf32-littleriscv


Disassembly of section .text:

80000000 <_start>:
80000000:	00400e13          	li	t3,4
80000004:	00a00513          	li	a0,10
80000008:	0d7572d7          	vsetvli	t0,a0,e32,mf2,ta,ma,d1
