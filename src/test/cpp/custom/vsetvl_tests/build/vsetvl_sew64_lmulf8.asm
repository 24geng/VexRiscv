...
build/vsetvl_sew64_lmulf8.elf:     file format elf32-littleriscv
...
80000004:	10de0e13          	addi	t3,t3,269 # 810d <_start-0x7fff7ef3>
80000008:	00a00513          	li	a0,10
8000000c:	05d00593          	li	a1,93
