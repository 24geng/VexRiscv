...
build/vsetvl_sew8_lmul8.elf:     file format elf32-littleriscv
...
80000004:	103e0e13          	addi	t3,t3,259 # 8103 <_start-0x7fff7efd>
80000008:	00a00513          	li	a0,10
8000000c:	04300593          	li	a1,67
