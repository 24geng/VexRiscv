...
build/vsetvl_sew8_lmul4.elf:     file format elf32-littleriscv
...
80000004:	102e0e13          	addi	t3,t3,258 # 8102 <_start-0x7fff7efe>
80000008:	00a00513          	li	a0,10
8000000c:	04200593          	li	a1,66
