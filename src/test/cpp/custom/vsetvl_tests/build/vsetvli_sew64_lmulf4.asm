...
build/vsetvli_sew64_lmulf4.elf:     file format elf32-littleriscv


Disassembly of section .text:

80000000 <_start>:
80000000:	00500e13          	li	t3,5
80000004:	00a00513          	li	a0,10
80000008:	0ee572d7          	vsetvli	t0,a0,e256,mf4,ta,ma,d1
